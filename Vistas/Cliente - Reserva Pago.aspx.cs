...
namespace Cliente
{
    public partial class Cliente___Pago_reserva : System.Web.UI.Page
    {
        ...
        protected void lnkConfirmacion_Hora(object sender, EventArgs e)
        {
            Response.Redirect("Cliente - Reserva Confirmacion.aspx");
        }
