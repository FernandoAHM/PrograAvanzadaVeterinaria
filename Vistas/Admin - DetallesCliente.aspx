<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin - DetallesCliente.aspx.cs" Inherits="Cliente.Admin___DetallesCliente" %>
    ...
    <form id="form1" runat="server" style="height: 100%; width: 100%; margin: 0;">
        ...
        <div id="editable" style="background-color: aqua; height: 58%">
            ...
            <p style="margin-left: 10%">
                <asp:Label ID="lbNombre" runat="server" Text="Nombre"></asp:Label><br />
                <asp:Label ID="lbRUT" runat="server" Text="RUT"></asp:Label><br />
                <asp:Label ID="lbMascotas" runat="server" Text="Mascotas"></asp:Label><br />
            </p>
        </div>
