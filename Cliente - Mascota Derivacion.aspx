<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cliente - Mascota Derivacion.aspx.cs" Inherits="Cliente.Cliente___Mascota_Derivacion" %>
        ...
        <div id="editable" style="background-color: aqua; height: 58%">
            ...
            <asp:Table ID="Table2" runat="server" style="width:70%;margin-left:10%;background-color:yellowgreen;height:100%">
                <asp:TableRow>
                    ...
                    <asp:TableCell style="text-align: center;vertical-align:super;width:70%">
              ...
              <h2 style="margin-left: 15%">
                ...
                Derivación <br/>
                  Nombre Mascota
                        ...
                        TEXTO SI LA MASCOTA HA SIDO O NO DERIVADA
                        <br/>
                   Lorem Ipsum is simply dutext ever since the 1500s, when an unknown prentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                    ...
                    <asp:TableCell>
                        ...
                        <br />
                        <asp:Button ID="Button4" runat="server" Text="Volver" Style="padding: 10%; width: 100%" />
                        <br />
                    </asp:TableCell>
                </asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell style="text-align: center;vertical-align:super">
                          ...
                          <asp:Button ID="Button5" runat="server" Text="Imprimir derivacion" Style="padding: 1%; width: 60%" />
                </asp:TableCell>
            </asp:TableRow>
