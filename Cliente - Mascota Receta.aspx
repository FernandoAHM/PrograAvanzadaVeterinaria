<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cliente - Mascota Receta.aspx.cs" Inherits="Cliente.Cliente___Mascota_Receta" %>
        ...
        <div id="editable" style="background-color: aqua; height: 58%">
              ...
              <h2 style="margin-left: 15%">
                ...
                Receta <br/>
                  Nombre Mascota
                        ...
                        TEXTO SI LA MASCOTA TIENE RECETAA
                        <br/>
            ...
            <asp:TableRow>
                <asp:TableCell style="text-align: center;vertical-align:super">
                          ...
                          <asp:Button ID="Button5" runat="server" Text="Imprimir Receta" Style="padding: 1%; width: 60%" />
                </asp:TableCell>
            </asp:TableRow>
